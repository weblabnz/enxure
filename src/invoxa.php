                        ...
                        <div class="card">
                            <div class="card-body doc-content">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Code organization</strong> — invoxa.php's client, stats, exports, and payments logic moved into separate files in 2.11.3 (see Changelog). Settings, Backup &amp; Restore, auth/API tokens, and the page template remain in one file; the same split is planned for those next.</li>
                                </ul>
