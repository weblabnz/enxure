                        ...
                        <div class="card">
                            <div class="card-body doc-content">
                                ...
                                $__roadmapItems = [
                                    ...
                                    ['effort' => 'medium', 'title' => 'Client account statements', 'since' => '2026-09-12', 'seeAlso' => ['label' => 'Tax Email', 'target' => 'feat-data'], 'desc' => 'Every export today is either one invoice or a whole tax-year zip. A single client\'s running statement — every invoice and payment in a chosen date range on one PDF — is what a lot of B2B clients actually want for their own reconciliation, and it\'s a fairly small extension of the Tax Email zip machinery already in place.'],
