...
CREATE TABLE IF NOT EXISTS `enxure_clients` (
  ...
  `contact_name`   VARCHAR(150) NOT NULL DEFAULT '' COMMENT 'Optional AP/contact person at this client, e.g. for a company client. Falls back to client_name in the invoice greeting/PDF when blank.',
  `email`          VARCHAR(255) NOT NULL,
  `cc_email`       VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Optional address CC''d on every invoice email sent to this client, e.g. their AP inbox.',
